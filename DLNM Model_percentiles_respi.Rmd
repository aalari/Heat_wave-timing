---
title: "Effect of different Heat wave timing on respiratory mortality in France with DLNM -  Sensitivity Analysis with Temperature Percentiles"
...
plot(cpall1,col="blue",axes=T,lab=c(6,5,7),xlab="Percentile of Temperature",
  ylab="RR", ci.arg=list(density=20,angle=-45,col=4), ylim=c(0.70,1.4))
lines(cpall2, col="red", ci="area", ci.arg=list(density=20,col=2))
legend("topleft",c("First Period \n (I²=20.3%, X² test p-val = 0.0614)","Second Period \n (I²=45%, X² test p-val = 0.0000)"), horiz = TRUE
  ,xpd = TRUE,col=c("blue","red"),lwd=2,bg="white"
  ,cex=0.7,ncol=1,inset=0.01,bty="n")
...
plot(cpall1,col="blue",lab=c(6,5,7),xlab="Percentile of Temperature",
  ylab="RR", axes=F, ci.arg=list(density=20,angle=-45,col=4), xlim=c(min(xvar1),max(xvar1)), ylim=c(0.70,1.4))
